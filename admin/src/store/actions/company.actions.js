...
import { CREATE_COMPANY_URL, CREATE_DONE_SUCCESS, GET_ALL_COMPANY_URL, COMPANY_LIST_ALL } from "../constants/index";
...
// const updateInvestor = (token, id, user_name, email, phone ) => {
//     return dispatch => {
